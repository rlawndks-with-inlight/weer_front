...
const VideoContent = (props) =>{
    ...
    return (
        ...
        <Wrappers>
            ...
            <div style={{ backgroundImage: `url(${obj.channel_image_src})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center',width:'2rem',height:'2rem',borderRadius:'50%'}} />
            </div>
        </Wrappers>
        </>
    )
